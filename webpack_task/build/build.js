...
/* harmony import */ var _feature__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./feature */ "./src/feature.js");
...
const btn = document.getElementById('btn').addEventListener('click', function () {
  //console.log("called");
  const obj = new _feature__WEBPACK_IMPORTED_MODULE_3__.Handle();
  let data = obj.handle();
